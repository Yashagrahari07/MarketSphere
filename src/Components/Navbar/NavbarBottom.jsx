      ...
      <div className='max-w-container mx-auto'>
        <div className='flex flex-col items-center lg:flex-row justify-between w-full px-10 pb-4 lg:pb-0 h-full lg:h-24 relative'>
          <div className='flex h-12 cursor-pointer items-center gap-2 text-black lg:h-14'>
            <FaGripLines size='1.5rem' onClick={toggleDropdown}/>
            <button className='text-[14px] font-normal' onClick={toggleDropdown}>Shop by Category</button>
            {showDropdown && (
            ...
            <div className="flex gap-4 mt-2 ml-5 lg:mt-0 items-center pr-6 cursor-pointer relative lg:hidden">
          ...
          <div className='relative w-full lg:w-[600px] h-[40px] text-base text-black bg-white flex items-center gap-2 justify-between px-6 rounded-xl lg:h-[50px]'>
          ...
          <div className="hidden lg:flex gap-4 mt-2 lg:mt-0 items-center pr-6 cursor-pointer relative">
            <div className="flex"  onClick={toggleUserDropdown}><FaUser /><IoMdArrowDropdown /></div>
            {showUserDropdown && (
              <ul className='absolute top-6 right-0 z-20 w-auto text-white p-4 pb-6 rounded-md border border-gray-300 mt-2 bg-black'>
                <li className='text-white px-4 py-2 hover:bg-red-500 duration-300 cursor-pointer text-sm'>Login</li>
